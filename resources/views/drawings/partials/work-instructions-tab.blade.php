                    ...
                    <div class="p-4">
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <a href="{{ asset('storage/' . $file->file_path) }}" 
                               download="{{ $file->nama }}"
                               class="col-span-2 bg-gray-800 hover:bg-blue-600 text-white px-3 py-2.5 rounded-lg flex items-center justify-center transition-all shadow-sm hover:shadow-md text-sm font-medium"
