...
<script>
    ...
    // Upload form handler
    document.getElementById('uploadQualityForm')?.addEventListener('submit', function(e) {
        e.preventDefault();
    ...
    document.getElementById('fileQualityInput')?.addEventListener('change', function(e) {
