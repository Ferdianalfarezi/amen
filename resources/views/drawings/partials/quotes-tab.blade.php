                    ...
                    <div class="p-4">
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <a href="{{ asset('storage/' . $file->file_path) }}" 
                               download="{{ $file->nama }}"
                               class="col-span-2 bg-gray-600 hover:bg-blue-600 text-white px-3 py-2.5 rounded-lg flex items-center justify-center transition-all shadow-sm hover:shadow-md text-sm font-medium"
    ...
    document.getElementById('uploadQuoteForm')?.addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data.success) {
                ...
                notif.className = 'fixed top-4 right-4 bg-gray-600 text-white px-6 py-3 rounded-lg shadow-lg z-[200] flex items-center gap-2';
